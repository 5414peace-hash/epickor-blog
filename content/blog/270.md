---
title: "Seoul Salt Bread Bakery Guide: Routes and Real Prices"
slug: "270"
date: "2026-07-07"
updatedAt: "2026-08-09"
visibility: "public"
publishAt: ""
description: "Salt bread runs ₩1,190 to ₩3,500 in Seoul, and the cheapest is in Seongsu, not the suburbs. A bakery route built around 소금빵, bagels and old-school Seoul bakeries — and how to avoid spending the day in a queue."
...
## What Salt Bread Actually Costs In Seoul

Before the routes, the number, because it decides how many stops your morning can hold.

**Salt bread (소금빵) spans roughly ₩1,190 to ₩3,500 a piece in Seoul**, and the spread does not run the way visitors assume. The cheapest example is not in a sleepy suburb — it is in **Seongsu-dong**, one of the city's most fashionable districts, where a bakery sells them at **₩1,190** and made news for it. A Jongno bakery charges **₩1,690**, or **₩2,190** for the truffle version. A neighbourhood bakery in Nowon asks **₩3,500**.

<div class="table-scroll">

| Where | Price per piece |
|---|---|
| Seongsu-dong bakery | **₩1,190** |
| Jongno, plain 소금빵 | ₩1,690 |
| Jongno, truffle 소금빵 | ₩2,190 |
| Nowon neighbourhood bakery | ₩3,500 |

</div>

*Individual bakery prices reported in Korean coverage through 2026. Salt bread is priced per piece, so a three-stop bakery morning is a ₩5,000–10,000 exercise, not a ₩30,000 one.*

Two things follow. **Neighbourhood is a poor predictor of price** — the trendy district is not automatically the expensive one, so do not skip a stop on the assumption it will cost more. And because the item is cheap, **a bakery route is limited by appetite and queue time, not by budget.** Plan around how long you are willing to stand, not around what you are willing to spend.

## Why Salt Bread Became A Seoul Obsession

Salt bread — 소금빵 in Korean, literally "salt bread" — is often linked to Japanese shio pan (시오빵), a soft roll with butter inside and salt on top. Food & Wine and Eater have both traced the trend's broader spread through Japan, Korea, and social media. Eater specifically described how Korea helped popularize salt bread in the early 2020s, with Jayeondo becoming one of the most visible destinations for it.
...
Classic bakeries give you history. Taegeukdang (태극당), founded in 1946 and widely described as Seoul's oldest active bakery, belongs to this category. It is a useful reminder that Seoul bread culture did not begin with Instagram. Old cream breads, castella, monaka ice cream, and retro bakery cases tell a different story from the new wave.

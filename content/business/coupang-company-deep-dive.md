---
title: "Coupang Deep Dive 2026: How Korea Built Its Own Amazon"
slug: "coupang-company-deep-dive"
date: "2026-07-29"
visibility: "public"
publishAt: ""
description: "A public-info deep dive on Coupang, Korea's dominant e-commerce company, covering Rocket Delivery, 2025-2026 financials, Farfetch/R.LUX, and real risks."
ogImage: "/assets/images/business/coupang-company-deep-dive/coupang-delivery-truck.jpg"
tags: ["KoreanCompany", "Ecommerce", "Coupang", "Logistics", "CompanyDeepDive"]
...
sourceScope: "Coupang investor relations releases, SEC filings, official aboutcoupang.com corporate page, and reliable business/financial press (Reuters, Korea Herald, Korea Times, KED Global)"
amazon: true
---
...
![A real Coupang Rocket Delivery truck parked on a Seoul street, branded with the Coupang wordmark.](/assets/images/business/coupang-company-deep-dive/coupang-delivery-truck.jpg)
*A Coupang Rocket Delivery truck in Seoul — the owned-logistics fleet that is the whole basis of the "Amazon of Korea" comparison. Photo via Wikimedia Commons.*
...
<div class="table-scroll">
  <table>
    ...
    <tbody>
      <tr>
        <td>Rocket Delivery</td>
        <td>Owned-logistics same/next-day delivery, the core retail business</td>
        <td>The structural basis of the entire "Amazon of Korea" comparison</td>
      </tr>
      <tr>
        <td>Rocket Fresh</td>
        <td>Grocery delivery, bundled into Coupang's WOW membership</td>
        <td>Extends the owned-logistics model into perishables</td>
      </tr>
      <tr>
        <td>Coupang Eats</td>
        <td>Food delivery, competing directly with Baemin</td>
        <td>Grew from roughly 17% to 35.3% credit-card transaction share by 2024, a real #2 position</td>
      </tr>
      <tr>
        <td>Coupang Play</td>
        <td>Streaming service launched Dec 2020, partly built on acquired HOOQ assets</td>
        <td>Reached a reported 13% share of Korea's subscription video market by May 2025</td>
      </tr>
      <tr>
        <td>R.LUX + Farfetch</td>
        <td>Luxury vertical (launched Oct 2024) partnered with Farfetch since June 2025</td>
        <td>Gives Coupang customers access to roughly 1,400 luxury brands via 4-7 day "Rocket Jikgu" shipping</td>
      </tr>
      <tr>
        <td>Coupang Logistics Services (CLS)</td>
        <td>Owned delivery fleet, established 2018</td>
        <td>Runs "Rocket Growth" (3PL-style fulfillment for outside sellers) and "CLS Milkrun" (pickup from small sellers)</td>
      </tr>
    </tbody>
  </table>
</div>
...
![A real Coupang-branded insulated grocery delivery bag, shown open, marked with Coupang and Rocket Fresh branding.](/assets/images/business/coupang-company-deep-dive/coupang-reusable-bag.jpg)
*Coupang's Rocket Fresh grocery delivery bag — one of several verticals the company has built on top of its core logistics network. Photo via Wikimedia Commons.*
...
<div class="affiliate-inline-cta">
  <p><strong>Researching Korea's e-commerce landscape?</strong> As an Amazon Associate, EpicKor may earn from qualifying purchases. Compare <a href="https://www.amazon.com/s?k=ecommerce+strategy+book&tag=epickor-20" target="_blank" rel="nofollow sponsored noopener noreferrer">ecommerce strategy books</a> before applying any single market's playbook elsewhere.</p>
</div>
  ...
  <table>
    ...
    <tbody>
      <tr>
        ...
        <td>$34.5 billion (+14% YoY)</td>
        <td>Gross profit $10.1B, margin 29.4%</td>
        <td>Adjusted EBITDA margin 4.3%, down 23 bps YoY</td>
      </tr>
      <tr>
        <td>Q4 2025</td>
        <td>$8.8 billion (+11% YoY)</td>
        <td>($26) million</td>
        <td>vs. $156M profit in Q4 2024; company cites the data incident</td>
      </tr>
      <tr>
        <td>Q1 2026</td>
        <td>$8.5 billion (+8% YoY)</td>
        <td>($266) million</td>
        <td>vs. $107M profit in Q1 2025; breach-recovery vouchers cited</td>
      </tr>
    </tbody>
  </table>
</div>
...
<div class="table-scroll">
  <table>
    ...
    <tbody>
      <tr>
        <td>Data security</td>
        <td>The 2025 breach directly caused measurable revenue and profit damage in the following two quarters — a real, quantified example of security risk hitting the bottom line.</td>
      </tr>
      <tr>
        <td>Labor practices</td>
        <td>Ongoing government investigation into working conditions at logistics centers, with real, reported worker deaths.</td>
      </tr>
      <tr>
        <td>Regulatory/antitrust exposure</td>
        <td>Repeat KFTC fines for self-preferencing behavior, with litigation still unresolved as of the most recent reporting.</td>
      </tr>
      <tr>
        <td>Structural profitability gap vs. Amazon</td>
        <td>Coupang has no AWS-equivalent high-margin business subsidizing its logistics investment, which analysts cite as the core reason its profitability lags Amazon's despite a similar playbook.</td>
      </tr>
    </tbody>
  </table>
</div>
...
<div class="affiliate-inline-cta">
  <p><strong>Studying Korea's platform economy?</strong> As an Amazon Associate, EpicKor may earn from qualifying purchases. Browse <a href="https://www.amazon.com/s?k=ecommerce+business+book&tag=epickor-20" target="_blank" rel="nofollow sponsored noopener noreferrer">e-commerce business books</a> for the deeper playbook behind owned-logistics retail before comparing it to your own market.</p>
</div>
...
- <a href="https://www.aboutcoupang.com/aboutus/" target="_blank" rel="noopener noreferrer">Coupang official corporate page</a>
- <a href="https://ir.aboutcoupang.com/" target="_blank" rel="noopener noreferrer">Coupang Investor Relations</a>
- <a href="https://www.koreaherald.com/article/3354900" target="_blank" rel="noopener noreferrer">Coupang's ₩3 trillion Rocket Delivery expansion pledge (Korea Herald)</a>
- <a href="https://www.digitalcommerce360.com/2024/02/02/coupang-500-million-farfetch-acquisition-complete-despite-investor-pushback/" target="_blank" rel="noopener noreferrer">Coupang completes $500 million Farfetch acquisition (Digital Commerce 360)</a>
- <a href="https://shattered.io/coupang-data-breach-409m-fine/" target="_blank" rel="noopener noreferrer">Coupang data breach and regulatory fine (Shattered.io)</a>
- <a href="/business/musinsa-company-deep-dive">EpicKor Business: MUSINSA Deep Dive</a>

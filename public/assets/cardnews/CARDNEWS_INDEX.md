...
| `2026-08-21_194` | 194 | Korean Gift-Giving: The Gift Is Fine, the Meaning Might Not Be | 7 | rendered + structural gate PASS + caption ready | **NOT YET SCHEDULED — blocked by Meta's 29-day ceiling, not by anything wrong with the asset.** On 08-21 the composer would not take 2026-09-20. Put it on **09-21–09-23**, which is better placement anyway: Chuseok is 09-24–26 and that is Korea's gift-giving season. Source post 194 was corrected during production — its ogImage was a machine-parts street captioned as a gift shop. |
| `2026-08-21_223` | 223 | Korea e-Arrival Card vs K-ETA: 22 Countries Are Exempt, and the Paid One Cancels the Free One | 7 | rendered + structural gate PASS + caption ready | **NOT YET SCHEDULED — Meta's 29-day ceiling.** Earliest bookable date moves forward one day per day; put it in the run after `194`. No hard deadline, but the exemption it describes expires **31 Dec 2026**, so it is worth less every month it waits. |

...
| `2026-08-21_194` | 194 | Korean Gift-Giving: The Gift Is Fine, the Meaning Might Not Be | 7 | rendered + structural gate PASS + caption ready | **NOT YET SCHEDULED. The 29-day ceiling is no longer the blocker — as of 2026-09-03 it reaches ~10-02, and a planner read that day confirmed the last booked slot is 09-19 with 09-20 free.** On 08-21 the composer would not take 2026-09-20. Put it on **09-21–09-23**, which is better placement anyway: Chuseok is 09-24–26 and that is Korea's gift-giving season. Source post 194 was corrected during production — its ogImage was a machine-parts street captioned as a gift shop. |
| `2026-09-03_433` | 433 | Korean Ttukbaegi vs Dolsot, and Why Koreans Never Use Dish Soap | 7 | rendered + structural gate PASS + caption ready | **NOT YET SCHEDULED — held for the batch.** `pot-stamp` system. Visual Fit avg 98.6, lowest 97; all seven PNGs inspected. Three new Commons files found by API search on romanised Korean. |
| `2026-09-03_435` | 435 | Korean Kimchi Containers: The Press Plate Matters More Than the Lid | 7 | rendered + structural gate PASS + caption ready | **NOT YET SCHEDULED — held for the batch.** `pot-stamp` system. Visual Fit avg 98.0, lowest 94; all seven PNGs inspected. Card 03 is a diagram because **no photograph of a 누름판 is published anywhere**, including by the manufacturer that sells it. |
| `2026-09-03_438` | 438 | Korean Ramen Pots: Is the Aluminium One Safe? | 7 | rendered + structural gate PASS + caption ready | **NOT YET SCHEDULED — held for a full batch per the representative's instruction (2026-09-03).** New `pot-stamp` visual system. Visual Fit avg 98, lowest 97; all seven PNGs inspected. First of a kitchen-object batch; 433 and 435 are the intended companions. |
| `2026-08-21_223` | 223 | Korea e-Arrival Card vs K-ETA: 22 Countries Are Exempt, and the Paid One Cancels the Free One | 7 | rendered + structural gate PASS + caption ready | **NOT YET SCHEDULED. Ceiling cleared as of 2026-09-03** (planner-verified: booked through 09-19, 09-20 free). Since `194` is the date-sensitive one, the better order is now **`223` on 09-20 and `194` on 09-21** — that keeps the daily chain unbroken and still lands `194` inside its 09-21–23 window before Chuseok. No hard deadline, but the exemption it describes expires **31 Dec 2026**, so it is worth less every month it waits. |

...
export const GUIDE_GROUPS: GuideGroup[] = [
  {
    ...
    guides: [
      ...
      },
      {
        ...
        imageAlt: 'A Korean convenience store breakfast laid out on a counter.',
      },
      {
        slug: '281',
        title: 'The dosirak lunchbox, decoded',
        blurb: 'What is in the compartments, and how to tell a good box from a filler one.',
        image: '/assets/images/posts/281/korean-dosirak-meal.jpg',
        imageAlt: 'A Korean lunchbox with rice, meat and side dishes.',
      },
    ],
  },
  {

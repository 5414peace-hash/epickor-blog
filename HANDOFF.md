...
## Current Snapshot - 2026-08-22 (씨앗 게이트 신설·보정 + 리프레시 4편 + 아마존 링크 전수 교체 + 카드뉴스 3편 예약)
...
- **`npm run seeds:check` 신설 — 발행 4~8주 된 글이 살았는지 죽었는지 판정한다.**
  ...
  - **적용 4편: `218` 다이소(`ded0b957`) · `194` 선물문화(`e96eaa7a`) · `268` 쿠션 호수(`1fca98e3`) ·
    `248` 러닝크루(`24528241`).** **4편 모두 결함이 "빠진 항목"이 아니라 "틀렸거나 없는 사실"이었다.**
  ...
  - **다음 물 줄 글: `musinsa-company-deep-dive`(비즈니스 — 주간 주제 승인이 먼저 필요).**
    쿨다운 중 결손 13편도 대기 — `255`(₩ 1개뿐인 푸드홀 가이드)가 그중 가장 크다.

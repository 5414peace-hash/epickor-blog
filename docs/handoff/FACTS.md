...
- **추석 카드뉴스 예약** — `public/assets/cardnews/2026-08-20_200/` 7장 + caption.txt 준비 완료.
  **9/7 이전 슬롯 필요**(예매 9/7~11). 08-21~09-17 캘린더가 꽉 차 있으니 대표님 지시대로
  같은 날짜에 겹쳐 올린다. Meta 로그인 필요.

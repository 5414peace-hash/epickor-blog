...
- **2026-08-07 추출 실측 (`output/gsc/...2026-08-07`, 창 2026-05-05~08-04, 92일).**
  - **분기 클릭의 진짜 기준선은 348이 아니라 1,576이다.** CLAUDE.md "10배의 산수"의 348클릭은 **쿼리 CSV(1,000행 상한 + 프라이버시 필터) 합계**였다. 같은 추출본의 차트/페이지 테이블은 07-24 시점에도 이미 분기 1,000클릭대였고, 08-07 추출은 **1,576클릭 / 404,194노출**이다. 쿼리 테이블(이번 398클릭)은 클릭의 25%만 보여준다. **목표 산수를 쿼리 합계로 세우지 말 것.**

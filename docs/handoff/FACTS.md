...
- **2026-08-13 — 추석 2026은 목 9/24 ~ 토 9/26이고 추석 당일은 금 9/25, 대체공휴일 없다.** 대체공휴일은 신정과 추석이 **일요일**과 겹칠 때만 발생하는데 2026년 3일 중 일요일이 없다. **`200`의 H2 하나가 `Best Tourist Strategy For September 24-27`로 틀려 있다**(제목·description은 24-26로 맞음). 영어권 경쟁글 일부(korea-insider)도 `Sept 24-27`로 틀리게 적고 있다.

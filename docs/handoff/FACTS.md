...
## 신규 `444` 식용가위 — 대표님 구술 앵글 5편째, `022` 리트레드 (2026-09-06)

- **기존 글 `022`(2024)** "Korean Food Scissors Guide: Practical Tools and Hangover Drinks" — 가위+숙취음료 혼합, 노출 1·클릭 0. URL 규칙대로 유지, `022→444` 링크만 걸었다. `topic-dedup`이 제목 적중으로 잡았고 리트레드로 라벨해 진행.
- **기원 출처**: Korea Times 2015 칼럼 — 1970년대 냉면집에서 테이블 가위 시작, "an assault weapon on the table". 위생 논쟁: **조선일보 1985-06**("접대가위 때문에 갈비·냉면이 섬뜩하고 비위생적" 아이디어 공모), **동아일보 1985-07**(냉면 대장균 원인에 가위). 영어권에 이 층 없음.
- **가격(2026-09 실측)**: 다이소 대형 주방가위 ₩3,000(톱니, 평점 4.6/195건, pdNo 1046269) · 오복 No.104 약 ₩5,300~5,500(양손, 255mm) · 분리형 프리미엄 ₩10,000~20,000. 아마존: 피스코리아 K-305 `B01FJMAVZC`, 국산 BBQ 가위 `B096TC56H5`, 가위+집게 세트 `B08YZ1CTHC`. `amazon-links.json` 216개.
- **이미지**: Pexels 18936008(서울 갈비, 미사용 확인) · Commons "Korean barbecue - cutting a king oyster mushroom with scissors" **CC BY-SA 4.0, 대경라이프, 2018-10-17** · 다이소 제품 이미지(제품 식별용). Pexels 20036098·8896216은 이미 사용 중이라 제외.
- 발행 커밋 `3838b66c`, 라이브 검증 약 270초 후, 이미지 3장 200. 전체 `audit:image-context` 442편 Critical/High 0.

## 신규 `445` 세계적 한국 예술가 9인 — 대표님 구술 앵글 6편째 (2026-09-06)

- **선정 규칙(대표님)**: 한국 국적 + 한 방(올림픽·오스카)이 아니라 수십 년 축적. 사라 장·백남준(미국 국적) 제외, 김연아·봉준호는 FAQ에서 이유 설명.
- **핵심 실측**: 정명훈 라 스칼라 음악감독 2025-05-12 발표, 계약 **2027~2030**, 개관 이래 첫 아시아인(한국일보 2026-06-06, 부산 투어 예산 논쟁 포함) · 조수미 40주년: CONTINUUM 2026-05-08(11곡 중 10곡 한국 작곡가 신작), 파리 6/10, 예술의전당 9/4 리사이틀 **R 16만·S 14만·A 12만·B 10만**, 2026 호암상, 2025 프랑스 코망되르, 조수미 국제성악콩쿠르 2024 창설 · 강수진 국립발레단장 **2014~2026-04-02**(12년) · 진은숙 지멘스상 2024-05-18 €250,000, 통영국제음악제 예술감독 2022~ · 나윤선 《Lento》 독·프 골드, 2026 신보 《Lost Pieces》.
- **이미지**: 커먼즈 7장. 소치 2014 폐막식 조수미+나윤선(KOCIS CC BY-SA 2.0) 히어로 · 정명훈-마타렐라 2022 라 페니체(Quirinale attribution; 같은 세트 5·8번은 대통령만 나와 기각) · 정경화 싱가포르 2015 · 나윤선 부다페스트 2026-06-29 · 김덕수 파리 2024 · 서도호 Bridging Home 리버풀 2010 · 조수미 런던 2012(902px 원본 크기). **강수진은 커먼즈에 0장**, 진은숙은 삽화(CC0)뿐, 백건우 549px — 셋은 사진 없이 감.
- **커먼즈 API는 연속 호출 시 429를 낸다** — 요청 사이 4초 이상 두고 User-Agent에 연락처를 넣을 것.
- **아마존 ASIN**: Lento `B00B5HE9LI` · Only Love 2CD `B0006BCPJC` · 정경화 워너 전집 `B01KBI5O06`(데카 전집 `B00NVY8V6M`은 절판) · 앨리스 블루레이 `B00FTGC5KI` · 서도호 테이트 도록 `1849769672`. DB 221개.
- 발행 커밋 `98ea7028`, 라이브 약 270초, 전체 `audit:image-context` 443편 Critical/High 0.

## 신규 `446` 한국 맥주 · `447` 소주 — 대표님 구술 7·8편째 (2026-09-06)

**맥주 `446`**
- **이코노미스트 2012-11-24 "Fiery food, boring beer"(대니얼 튜더)**: "brewing remains just about the only useful activity at which North Korea beats the South". 튜더는 2013 더부스 공동창업, 첫 맥주 미켈러 협업 '대동강 페일에일'. 코리아타임스 2017-12-01 반론(램지 2017 카스 광고).
- **대동강맥주**: 2000 김정일이 영국 Ushers of Trowbridge 설비 £150만 매입 → 2002 가동, 5~5.5%, 7종, 2005~07 남한 수출 후 70% 인상으로 중단(위키).
- **IWSR 2025(아시아경제 2025-07-28)**: 총 2억 3,351만 케이스(5년 CAGR 0.1%), 카스 1억 644만(+76.8%), 테라 3,667만(−8.5%), 하이트 2,672만(−9.9%), 켈리 929만(+29.6%); AB인베브 52.1% / 하이트진로 33.5%; 가정용 73.6%. 카스 가정용 48%(2026 1Q), 테라 12.9%(2023)→10%. OB 원가율 40% vs 하이트진로 50%+(글로벌에픽 2025-11-13).
- **켈리(하이트진로 공식)**: 2023-04-04, 4.5%, 덴마크 맥아 100%, 발아 24h 연장, 7℃→−1.5℃ 이중숙성, 앰버병, 첫해 3.6억 병. 테라 2019-03-21, 4.6%, AGT 맥아(후에 '호주산'으로 라벨 확대).
- **역사**: OB 1933 쇼와기린 / 조선맥주 1933 대일본맥주 · 카스 1994-06 진로쿠어스 → 1999-12 OB 인수 · 하이트 1993 → **1996년 43.0% vs 41.6%로 1위**(두산전자 1991 옥계천 페놀 → 불매) · 필라이트 2017-04-25(맥아 10% 미만=발포주) · 2014-04 소규모 양조 외부 유통 허용 · 2020 종량세 · 주세 1990년대 150% → 72%.
- **수제맥주**: 점유율 2018 1.4% → **2022 4.92% 정점** → 2025 약 1.8%(570억/3.1조). 곰표 2020-05 CU 5~6천만 캔 → 2023-03 제주맥주로 이전 → 세븐브로이 2025-08 상폐 수순 · 제주맥주 2024-03 더블에이치엠 101억 매각 → 2025-04 한울앤제주 → 2025-12 세 번째 주인 · 어메이징브루잉 2026-04-21 파산 · 양조장 약 170곳 중 편의점 5~6곳(비즈한국 2026-04-28).
- **2026 편의점**: 캔 ₩4,500(미켈러·히타치노)·₩4,900(OBC)·₩6,300(서울브루어리), 4캔 ₩13,000~17,200(조선비즈 2026-06-21) · GS25 "전국 수제맥주 여행" 2026-04-08 강릉 버드나무 6캔 ₩35,000 와인25플러스 픽업 · OBC 헬레스/비엔나 GS25 2026-06.
- **가격 실측**: 카스 500ml 캔 ₩2,800(2022-04~), 테라·켈리·하이트 500ml 병 ₩2,500(2025-06-01, 뉴데일리), 필라이트 500ml ₩1,750(편픽 2026-09). **초안은 전부 추정치였고 2차 검증에서 잡혔다.**
- 치맥페스티벌 2026: 115만 명, 외국인 약 10만(매일신문 2026-07-06).
- 이미지: 커먼즈 6장(대구시 KOGL 치맥 히어로·대동강 2012·OB/카스/하이트 2011·카스 생맥·하이트·평양 마이크로브루어리) + 켈리 제조사 배너 크롭(테라 배너는 손흥민 광고라 기각). 하이트진로 배너는 `file.hitejinro.com/.../category/` 경로이며 **Referer 없이는 0바이트**.

**소주 `447`**
- **도수 연표(한국일보 2023-03 100년 시리즈)**: 1924 35(원숭이) · 1955 두꺼비 · 1965 양곡관리법→희석식 30 · 1973 25 · 1998 참이슬 23 · 2001 22 · 2004 21 · 2006 19.8(처음처럼 20) · 2014~18 17 · 2019 진로이즈백 16.9 · 2021 16.5 · 2023 선양 14.9 · 2024 진로골드 15.5 · **2026 새로 1월·진로 2월·참이슬 후레쉬 6월 15.7**(뉴스핌 2026-06-02, 직전 조정 2024-02). 업계 하한 14도.
- **원가 산수**: 0.1도 = 병당 0.6원(대한경제 2024-02-26) · 하이트진로 소주 매출 1조4,690억→1조5,480억(+5.4%) vs 주정 매입 2,767억→2,763억(−0.1%)(뉴스웨이 2025-07-11) · 대한주정판매 = 주정 10사 JV 독점 유통, 2022 +7.8%(10년 만), 2023 +9.8%.
- **출고가**: 2012-12 → 2015-11-30 961.7→1,015.7(+5.62%) → 2019-05-01 1,081.2(+6.45%) → 2022-02 +7.9% → 2023-11-09 +6.95%(주정 +10.6%, 신병 +21.6%). 편의점 2023 ₩2,100 → 2024-01 ₩1,900 → 2026-09 ₩1,900(편픽), 진로골드 ₩1,800. 식당 2019 ₩3,000~4,000 → 2022 "5,000원 시대" → 2024 ₩6,000 → 2026 ₩4,000~7,000.
- **음주 감소**: 국세청 2025 출고 2,987,726kL(1998년 이후 최저, 2015 정점 4,073,615 대비 −26.7%), 희석식 소주 86.2만→84.4→81.6→79.3만 kL(2022~25), 맥주 2025 −7.2%(부산일보 2026-08-23) · 질병청: 20대 하루 95.5g(2023)→64.8g(2024), 60대 66.8g; 19~29세 월 1회 이하 56.0%(2005년 37.9%) · 농협은행 20대 주점 소비 −20.9%, 30대 −15.5%(부산일보 2026-07-16).
- **새로**: 2022-09 출시, 7개월 1억 병, 2025 말 8억 병; 롯데 소주 점유율 16.6%→20.7%. 진로: 2024-01-09 제로슈거 리뉴얼, 2019~2025 누적 약 25억 병.
- **진로 세계 1위**: Drinks International 2026, 25년 연속, 9,450만 케이스, 91개국.
- **초록병**: 1994-01 두산 그린소주 → 2009 환경부 공용병 협약(360ml 초록) → 2019-04 진로이즈백 하늘색(70일 1,000만 병), 롯데가 진로 공병 200만 개 보유 분쟁.
- 아마존: 진로 소주잔+두꺼비 오프너 `B09PKP6WWR`, 레트로 잔 4개 `B0CXPNC77G`. DB 224개.
- 이미지: 커먼즈 6장 + 진로25 제조사 배너. `File:Soju in korean restaurant.JPG`는 **홍콩** 한식당이라 기각.

## 신규 `448` 막걸리·전통주 — 대표님 구술 9편째, 술 3부작 완결 (2026-09-06)

- **전통주 법적 정의(전통주산업법 2010)**: 민속주 = 국가/시도 무형문화재 보유자·식품명인이 국산 농산물로 / 지역특산주 = 농업인·농업회사법인이 제조장 소재지·인근 농산물로. **방식 무관.** 그래서 **원소주(농업회사법인+원주 쌀 100%)는 전통주, 장수막걸리·백세주·화요(광주요는 도자기 회사)·일품진로는 아님**(농민신문 2022-06-19). 통신판매: 1998 우체국 → 2017 온라인몰 → **2019-04-01 타사 전통주도 자기 직매장 구입분이면 가능**. 주세 50% 감면: 2025-02-28부터 직전년 출고 발효주 1,000kL·증류주 500kL 이하로 확대, 지역농산물 100→95%.
- **원소주**: 2022-02 출시, ₩14,900, 22%, 첫 물량 172만 병, 2022-03-31 온라인 판매(1인 1일 6병).
- **탁주 출고량** 38만 kL(2020) → 31.8만 kL(2025). **전통주 출고** 2024 22,978kL·1,374억 → 2025 22,284kL(−3.0%)·**1,459억(+6.2%)**, 출고액 비중 약 1.5%. 지역특산주 탁주 2025 12,852kL·609.8억(+5.0%/+26.5%)(2026 국세통계연보, 코리아술 블로그 정리).
- **서울장수**: 1962 서울주조협회, 1963 51개 양조장 합동, 전국 40%·서울 70%, 장수 생막걸리 연 2억 병. 편의점 2026-09: 국순당 ₩1,800 · 장수 ₩1,900(6%) · 지평 ₩2,300(5%) · 느린마을 ₩3,400(6%), 750ml(편픽).
- **해창**: 12도 ₩12,000, **18도 ₩110,000**(역대 최고가 막걸리), 10도 플러스 900ml 무아스파탐(농민신문 2024-08-23). 아스파탐: 2023-07 IARC 2B → 장수·국순당·지평 등 평균 0.0025% 사용, "하루 33병" → 업계 무아스파탐 전환.
- **막걸리 쌀 연표**: 1964~65 쌀 금지 → 밀가루 80%·옥수수 20% → 1971 잠시 허용 → 1977 쌀 의무 → 1990년대 초 쌀 과잉으로 정착.
- **양조용 쌀(농민신문 2023-09-20)**: 한국 약 3품종(설갱=국순당+농진청, 양조벼, 한아름4호; 가평 보람찬), **국순당 외 거의 안 씀**; 예외 마스브루어리 수향미·두술도가 희양산우렁쌀. 일본 주조호적미 100종+, 양조장 직접 재배, 닷사이 23 정미율 23%. 국산 쌀 = 수입 3배, 원재료 원가 47.1%(농민신문 2023-09-15: 기피 사유 = 살 곳 없음·비싸 보임·숙취).
- **안동소주**: 45%, 1987 경북 무형문화재(조옥화)·박재서 식품명인, 375ml ₩22,400~25,000. **2026-06 경북도 소주스토리 양조장 ₩120억, 연 60만 L(160만 병)**, 수출 8.17억(2023)→11.78억→12.7억(2025), 14개국(경향 2026-06-25).
- **편의점 전통주 2026**: 7-Eleven 1/1~8/12 +55% YoY, 2021 대비 7배, 2030 비중 36%(+8p) · CU 신라주 375ml ₩18,600 · GS25 자가소주 김부장 31°/송과장 21°(2026-08-24). 롯데백화점 2030 전통주 +130%(2025).
- **케데헌×전통주 협업은 미확인** — 호작도 모티프 디자인 경향으로만 서술.
- 아마존: 왕 누룩 2팩 `B093GK9MQK`, K-막걸리 키트(용기) `B0DBVT1158`. DB 226개.

## 신규 `449` 한국 과일값 — 내가 직접 캔 첫 주제 (2026-09-06)

- **주제 선정 기록**: 후보 12(카페·메가커피·배달·치킨값·편의점 폐점·전세·학원·성형·파리바게뜨·성심당·과일값·현대차·아이폰/갤럭시·목욕탕). 제목 충돌: 배달(`178`)·성심당(`264`)·성형(`023`). 영어 포화로 기각: 아이폰/갤럭시(갤럽 2026 20대 아이폰 53%·20대 여성 67%·60대 삼성 ~100%인데 헤럴드·중앙데일리·SCMP가 이미 씀). 추천 3: 과일값 → 카페 경제 → 목욕탕 소멸.
- **넘베오 2024-03-26**: 사과 1kg 한국 $6.82 세계 1위(미국 4위 $5.31, 일본 7위 $4.50), 바나나 $3.45·감자 $3.94·오렌지 1위. 한은 "우리나라 물가 수준 특징": 사과·티셔츠 OECD 1위, 의식주 55% 높음, 원인 = 낮은 생산성·유통비용·제한적 수입.
- **금사과**: 2024-03 사과 CPI +88.2%(1980년 이후 최대), 마트 ₩5,000·백화점 ₩15,000, 도매 10kg ₩84,646(2024-06, 평년 +35%). 2023 생산 −30%(경북 3월 +3.6℃ 조기개화 → 4월 냉해), 경북 = 전국 58%. 2025-03 산불 3,386ha(10%).
- **수입 0**: 1948년 이후 생사과·배·복숭아·수박 수입 전무(한경 2024-11-07, 비즈워치 2025-06-14). 8단계 평균 8년. 사과: 일본 1992~ 5단계·독일 4단계 / 배: 벨기에·포르투갈 5단계 / 복숭아: 뉴질랜드 4단계 / 수박: 미얀마 1단계. 허용: 감귤 미·일·NZ, 감 일·NZ, 포도 미(텍사스·하와이 제외)·일·NZ, 망고 대만·필·태·호. 과수화상병 2015~ 미국산 밀수 묘목 추정. 2024 할당관세: 바나나·파인애플·망고·자몽·아보카도 30→0%, 오렌지 50→10%; 2025 5%로 연장(바나나 12.9만t 등 18.1만t).
- **유통비용률 2024 49.2%**(출하 9.4/도매 14.2/소매 25.6), 감귤 58.1%, 대파 ₩570→₩2,732(뉴스투데이 2026-08-06). 농식품부 2025-09-15 유통구조 개선안 10% 절감 목표.
- **농장**: 사과 농가 0.5ha 미만 52.9%, 0.5~1ha 21.1%; 과수 농가 65세+ 64.2%(2024). 과일 재배면적 172,090ha(2000)→158,830(2022), 6대 과일 생산 225만→191만t. 강원 사과 4,472t(2015)→22,699t, 경북 10년 −25%; 2050년대 강원 고지대만.
- **소비**: 1인당 67.9kg(2007) → 55.0kg(2022), 6대 과일 47.7(2000)→34.9(2018). KREI 2024 식품소비행태: **수박 12.8% > 사과 12.6%**(2019 사과 16.2%), 10대 딸기 11.3·수박 10.8·포도 9.3·사과 8.8.
- **샤인머스캣**: 소매 2kg ₩28,113(2023-09) → ₩16,572(2026-09, −41.1%), 도매 kg ₩12,363(2022)→₩6,737(2025, −45.3%), 8월 도매 2kg ₩12,000. 재배면적 43.1%(2024), 가락 포도 47.9%. 경북 16브릭스·400~1,000g 기준.
- **2026 여름**: 수박 1개 ₩24,467(8/7, −24.6%, 평년 −12%), 7월 도매 8kg ₩20,023(−28.4%), 복숭아 10개 ₩18,602(−17.4%), 사과 도매 10kg 보통 ₩21,040·상 ₩30,957(8/4).
- **선물세트 2026 추석**: 롯데백 사과·배 ₩124,000, 애플망고 혼합 ₩132,000; 마트 GAP ₩30,000~50,000, 이마트 ₩49,800; aT 평균 예산 약 ₩160,000. 못난이: 롯데마트 상생과일 +180%(2024 1~7월), 홈플러스 맛난이 30% 할인 134점.
- 아마존: 청도 곶감 `B0FGPJ362T`, 담터 한라봉차 `B07MLTY288`, 담터 유자차 `B074TZFYRR`.
- 이미지: 커먼즈 7장 — 경주 성동시장(2006)·**신고배 ₩6,000/₩7,800 가격표(2007)**·명동 참외 리어카·제주 한라봉·샤인머스캣·백화점 선물세트·곶감. 경동시장 사진은 약재라 기각.

## 신규 `450` 카페 경제 — 내가 캔 추천 2번째, 대표님 5개 추가 (2026-09-06)

- **카페 수**: 10만 개+(2026, 국세청·소진공, 더바이어 2026-09-04) = 편의점 약 5.5만의 2배. 2024 기준 한국 96,473(536명당 1) / 일본 47,530(2,630명당 1, 1981년 정점 154,630) / 미국 78,851(4,402명당 1). 프랜차이즈 브랜드 921개·가맹점 29,101개(브랜드당 31).
- **서울 vs 뉴욕**: 서울 2022 2.5만+ → 3만+ (605km²), 뉴욕 약 3,000(780km²) → 면적당 약 10배; 주민당 서울 1,000명 vs 뉴욕 1,600명(연합 2025-12-05, **NYT "South Korea Has a Coffee Shop Problem"** 인용). 사장 인터뷰 "하루 13시간, 월 400만 원".
- **소비**: 1인당 405잔(2023, 프랑스 551 다음 2위, 세계 평균 152, 미국 318), 2018 363잔. 커피 수입 2024 $13.78억(+11%).
- **가격 2025(이투데이)**: 매머드 ₩1,200 · 컴포즈 ₩1,800 · 메가/빽/더벤티 ₩2,000 · 이디야 ₩3,200 · 할리스 ₩4,500 · 스벅/투썸/파스쿠찌/폴바셋 ₩4,700 · 커피빈 ₩5,000. 메가 2025-04 첫 인상(HOT 1,500→1,700, ICE 2,000 동결).
- **스타벅스 톨 아메리카노**: 1999 ₩3,000(숏 2,500) → 2012 3,600 → 2013 3,900 → 2014 4,100 → 2022 4,500 → **2025-01-24 4,700**. 매장 327(2010) → 2,185(2026-06). SCK컴퍼니(이마트 67.5%·GIC 32.5%, 2021). **세계 3위**(2,009 vs 일본 1,901; 미국 17,049·중국 7,685; 머니투데이 2025-03-20), 인구당 1위(2.5만 명당 1), 서울 32%·강남구 90개·테헤란로 3.8km 17개. 2001년 서울 메뉴판 사진(커먼즈, 아이스 아메리카노 ₩3,000).
- **원두 원가**: 톨 아메리카노 2샷 ₩222 = 4.7%(소비자단체협의회, 데이터솜 2025-09-16); 저가 브랜드 12~13%.
- **메가커피(앤하우스)**: 2015 홍대 1호, 2024-06 3,000, **2026-06 4,466**. 2023 매출 3,684억(+110.7%)·영업이익 694억(18.8%). 2021 프리미어+우윤 ₩1,400억 인수, 프리미어 MOIC 2배 엑시트. 로열티 월 ₩15만, 창업비 10평 ₩7,400만(실제 2~3억). 손흥민 광고 ₩60억, 점주 월 ₩12만 분담 논란(2022-12).
- **컴포즈**: 2025-09 3,000점. 2024-07 **졸리비** $238M(EV $340M), 70%. **빽다방** 1,800+(2026-06). 이디야 2,562. 저가 4사 약 1만.
- **커피빈코리아**: 291(2019)→279→258→238→228→221(2024), **2025 영업손실 약 11억(첫 적자)**, **2025-12-29 가맹 정보공개서 자진 취소**(직영 회귀).
- **폐업**: 서울 2025 1Q 커피·음료 폐업 4.0% > 개업 3.1%(2015년 이후 첫 역전, 연합 2025-06-13); 식음료 연 폐업 12~15%, 3년 내 40%+; 마진 15~20%→5~10%(더바이어). 2026 상반기 자영업 폐업 62.4만 건 사상 최대, 폐업/창업 1.32(국세청 2026-07-15).
- **구루**: 은현장·유정수 유튜브 "돈 벌고 싶으면 장사 접으세요" 실재. 백종원 "하지 마라" 직접 발언 미확인 → 연돈볼카츠 83개 중 62개 폐업(KBS 추적60분 2024-07)으로 대체. "1%" 수치는 출처 없어 미사용.
- **카공**: 노스터디존(울산 2025-10), 'NO 20대존'(2023-08), 2~3시간 제한, 콘센트 봉쇄, 1인 1음료.
- 아마존: 카누 미니 30 `B0F9Y58R7Z`, 카누 70 `B018SK2Z56`. 메가커피 공식 이미지 `img.79plus.co.kr/megahp/...` Referer 필요.

## 신규 `451` 목욕탕 — 내 추천 3번째, 대표님 논지 반영 (2026-09-06)

- **드래곤힐스파(용산)는 영업하지 않는다.** 2021 코로나 잠정 휴업 → 2022 하반기 이후에도 미재개 → 2025 지도·플레이스 등록 삭제, 1층 식당 입점. 공식 폐업 선언은 없음(나무위키·dragonhillspa.net). **`176`은 언급 없음.** 외국 가이드북은 아직 추천 중.
- **전국 목욕장**: 8,904(2000) → **9,919(2003 정점, 4,800명당 1)** → 8,426(2010) → 7,467(2015) → 6,529(2020) → 6,012(2022) → **5,656(2025)**(한국일보 2023-01-19, 한경 2026-04-15). 2020~22 730곳 폐업. 최초 허가 1954-01-31 부산 금정탕(2013 폐업).
- **서울**: 1995 1,764 → 2025 510(−71%, 시사저널 2026-03-30); 허가 663곳 중 132곳(19.9%) 30년 이상. 중구 ㄴ사우나 1998~, 누적 적자 ₩4억, 2026 폐업 예정.
- **요금**: 서울 성인 평균 ₩10,077(2023 말, 첫 1만 원 돌파), 강원 ₩9,444(2025-11). 2020 요금표 사진: 목욕 ₩8,000·찜질 ₩10,000·수면타월 ₩3,000. 경기 한 업소 월 운영비 약 ₩3,000만. 세신: 목욕탕 ₩20,000~30,000 / **1인 세신숍 ₩50,000~80,000**(비즈한국 2023-03-23; 30~40대 여성·임산부, 100% 예약, 학원 재개원).
- **일본 센토**: 17,999(1968) → 1,562(2025) → **1,493(2026)**, 도쿄 400대. 운영자 평균 69.6세, 2026 이란발 유가 급등으로 노포 폐업, 요금 상한(도쿄 ¥550, 손익 ¥650 필요; 효고 ¥490→¥570). **그러나 시장은 FY2025 약 ¥1,200억(+5%, 코로나 이후 최고, 고객층 젊은층·가족으로 확대, 제국데이터뱅크 2026-04)**. 2019 드라마 《사도》 사우나 붐, 고스기유(고엔지 1933), 고가네유(2020 리뉴얼, 2026-01 신주쿠 2호점), 유토나미 10곳 ¥4.7억, 도쿄 관광객 ¥300 쿠폰(2025 말).
- **개인탕 수요**: 부킹닷컴 2023 한국 MZ 조사 마사지·온천 54%(1위); 개인탕 객실 겨울·주말 2~3주 전 예약 권고; 경주 라궁 전 객실 온천.
- **리버사이드호텔**: 1981 개관(잠원, 지하2·지상13, 강남 1호 특급), 80년대 사우나 ₩10,000; 47층 복합개발 확정(용적률 1000%), **2026 착공·2030경 개관**; 스파는 '더메디스파'로 운영 중(연회비 ₩2만 프로모션). 공식 사진 `riversidehotel.co.kr/theme/theme_10/img/privacy/`.
- **허심청**: 부산 동래 호텔농심 온천탕, 커먼즈 PD 사진 2장(2018).
- **아파트 커뮤니티**: 2025 조사 '다양한 커뮤니티' 선호 1위 34%; 원베일리 수영장·피트니스·사우나·게스트하우스 월 약 ₩45,000; 헬리오시티(9,510세대) 시설당 ₩1~2만; 철산역자이 수영장+유아풀+사우나.
- 아마존: 양머리 수건 `B0FS147HW9`(232개). 이태리타월은 기존 `B00VKJW42M`.
- **커먼즈에 한국 동네 목욕탕 외관·굴뚝 사진이 없다**(6개 검색어). 가장 가까운 것은 1930년 동래온천 372px.

### `451` 이미지 2차 정정 (2026-09-06, 대표님 재검토)
- 대표님: 히어로(허심청 건물)와 2번(찜질방 요금표)은 "엉뚱하다". 허심청은 논지에 중요하지 않으니 빼라. 한국 목욕탕 **내부** 사진을 넣어라.
